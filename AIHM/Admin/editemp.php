...
session_start();
 ...
 if(isset($_REQUEST['empupdate'])){
  ...
  $sql = "UPDATE doctor_tb SET empName = '$eName', empCity = '$eCity', empMobile = '$eMobile', empEmail = '$eEmail' WHERE empid = '$eId'";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM doctor_tb WHERE empid = {$_REQUEST['id']}";
